...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        outbox.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this, SuratKeluarActivity.class));
        ...
        dispo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this, DisposisiActivity.class));
                Toast.makeText(getApplicationContext(), "Disposisi Telah Dipilih", Toast.LENGTH_SHORT).show();
            }
        });
...
//        final String iduser = preferences.getString("username",null);

        requestQueue= Volley.newRequestQueue(getApplicationContext());
        @SuppressLint("WrongConstant") SharedPreferences preferences= getSharedPreferences("Login",MODE_APPEND);
        final String id_user= preferences.getString("username",null);
